...
import com.code.model.vo.AddressVo;
...
public class AddressUtils {
    ...
    // 这里调用淘宝API
    private static String urlStr = "http://ip.taobao.com/service/getIpInfo.php";
...
//            e.printStackTrace();
    ...
    public static AddressVo getAddressByIp(String ip) {
        try {
            JSONObject json = JSONObject.fromObject(JSONObject.fromObject(AddressUtils.getAddresses("ip=" + ip, "utf-8")).get("data"));
