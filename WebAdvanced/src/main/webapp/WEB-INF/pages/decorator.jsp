                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img class="img-circle"
                                     src="https://avatars1.githubusercontent.com/u/6011374?s=460&v=4">
                                <p>
                                    Web全栈开发进阶之路
                                    <small>努力</small>
                                </p>
        ...
        <section class="sidebar">
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="https://avatars1.githubusercontent.com/u/6011374?s=460&v=4" class="img-circle"
                         alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree" data-sidekey="<sitemesh:write property='sidekey' />">
                ...
                <li class="treeview four">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="${ctx}/four?p=daterangepicker2"> <i class="fa fa-circle-o"></i> 4.6 DateRange
                                Picker
                            </a>
                        </li>
                        <li>
                ...
                <li class="treeview six">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="btreeview">
                            <a href="${ctx}/sitemesh?p=bootstrap-treeview"> <i class="fa fa-circle-o"></i>
                                Bootstrap-Treeview
                            </a>
                        </li>
                    </ul>
                ...
                <li class="treeview seven">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="fileinput">
                            <a href="${ctx}/sitemesh?p=bootstrap-fileinput"> <i class="fa fa-circle-o"></i> Bootstrap
                                FileInput
                            </a>
                        </li>
                        <li class="summernote">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="treeview">
                                    <a href="#"> <i class="fa fa-circle-o"></i> Level Two <span
