...
public class BaseDAO<T> implements Serializable {
	...
	public List findWithSelect(String queryString, Map<String, Object> params, int startRow, int pageSize)
	...
	public List<T> find(String queryString, Map<String, Object> params, int startRow, int pageSize)
			throws DataAccessException {
	...
	public PageUtil<T> pagefind(String hql, Object[] args, Map<String, Object> alias) {
		log.debug("DAO:Excute HQL update :" + hql);
		hql = initSort(hql);
	...
	public <N extends Object> PageUtil<N> findBySql(String sql, Object[] args, Map<String, Object> alias, Class<?> clz,
			boolean hasEntity) {
		sql = initSort(sql);
	...
	public <N extends Object> PageUtil<N> findBySql(String sql, Object[] args, Class<?> clz, boolean hasEntity) {
		return this.findBySql(sql, args, null, clz, hasEntity);
	}

	public <N extends Object> PageUtil<N> findBySql(String sql, Object arg, Class<?> clz, boolean hasEntity) {
		return this.findBySql(sql, new Object[] { arg }, clz, hasEntity);
	}

	public <N extends Object> PageUtil<N> findBySql(String sql, Class<?> clz, boolean hasEntity) {
