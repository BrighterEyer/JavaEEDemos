...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<table id="dg" title="权限用户列表" class="easyui-datagrid"
		style="width: 1180px; height: 540px; margin: 10px 5px 15px 20px;"
		url="permission/get_permissions.html" toolbar="#toolbar"
	...
	<div id="toolbar">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-add" plain="true" onclick="newUser()">添加权限</a> <a
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-edit" plain="true" onclick="editUser()">编辑权限</a> <a
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-remove" plain="true" onclick="destroyUser()">删除权限</a>
	</div>
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" novalidate>
			<div class="fitem">
				<label>权限方法:</label> <input name="permissionname"
