					...
					<TD>
						<DIV style="MARGIN: 0px auto; WIDTH: 936px">
							<IMG style="DISPLAY: block"
								src="${demoPath}static/image/body_03.jpg">
						</DIV>
						<DIV style="BACKGROUND-COLOR: #278296">
							<DIV style="MARGIN: 0px auto; WIDTH: 936px">
								<DIV
									style="BACKGROUND: url(${demoPath}static/image/body_05.jpg) no-repeat; HEIGHT: 155px">
									<DIV
											...
											<TBODY>
												<TR>
													<TD style="HEIGHT: 43px"><INPUT id=username
														class=input type=text name=username required="true"></TD>
												</TR>
												<TR>
												...
												<TR>
													<TD style="HEIGHT: 50px"><INPUT id=checkcode
														required="true" class=yzm size=8 type=text name=checkcode>
														<a style="text-align: center;" id="verifyClick"
														title="点击 刷新?" href="javascript:void(0);"> <img
															style="width: 65px; height: 22px;" align="absmiddle"
															id="verifyCode" src="${demoPath}verifyCode.html" />
													</a></TD>
												</TR>
											</TBODY>
										</TABLE>
						...
						<DIV style="MARGIN: 0px auto; WIDTH: 936px">
							<IMG src="${demoPath}static/image/body_06.jpg">
						</DIV>
					</TD>
				</TR>
				<TR style="HEIGHT: 30%">
