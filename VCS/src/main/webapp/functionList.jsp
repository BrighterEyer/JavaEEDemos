...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<table id="dg" title="用户资源访问" class="easyui-datagrid"
		style="width: 1180px; height: 540px; margin: 10px 5px 15px 20px;"
		url="function/get_functions.html" toolbar="#toolbar" pagination="true"
	...
	<div id="toolbar">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-add" plain="true" onclick="newUser()">添加资源</a> <a
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-edit" plain="true" onclick="editUser()">编辑资源</a> <a
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-remove" plain="true" onclick="destroyUser()">删除资源</a>
	</div>
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post" novalidate>
			<div class="fitem">
				<label>允许访问路径:</label> <input name="value" class="easyui-textbox"
					required="true">
			</div>
			<div class="fitem">
				<label>访问权限:</label> <input name="permission_id"
					class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
				<label>角色:</label> <input name="role_id" class="easyui-textbox">
			</div>
			<div class="fitem">
