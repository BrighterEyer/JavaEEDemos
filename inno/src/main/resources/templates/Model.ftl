...
import ${package_name}.common.domain.BaseModel;
import ${package_name}.common.listener.ICreateListenable;
import ${package_name}.common.listener.IDeleteListenable;
import ${package_name}.common.listener.IModifyListenable;
